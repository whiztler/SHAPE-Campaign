...
/********** GENERAL **********/
_ADF_mission_version = 1.41; // Mission version
...
ADF_clanName = "SHAPE"; // What is the name of your community/clan. Used in Hints, intro's etc.
ADF_clanTAG = "SHAPE"; // What is the tag of your community/clan. Used in Hints, intro's etc.
ADF_clanLogo = "Img\clan_logo_SHAPE.paa"; // Full path to the clan logo. 
ADF_clanFlag = "Img\SHAPE-flag_blue.paa"; // Full path to the clan flag (dimensions 512 x 256, pref PAA format).
_ADF_MissionIntroImage = "Img\mission_cover_SHAPE.paa"; // Full path to the mission intro image (dimensions: 2038 x 1024, PAA format only). 
ADF_Clan_uniformInsignia = false; // Apply custom clan insignia on uniform. Define in the description.ext [true/false]. 
_ADF_preset = "SHAPE"; // pre-defined call sign/radio freq presets. [DEFAULT / SHAPE / NOPRYL / CUSTOM]. Configure the presets in 'Core\F\ADF_fnc_presets.sqf'
